...
import com.MLag.RedCraft.Items.FireItems.*;
...
public class ItemsRegisters {
    ...
    public static Item red_nugget = new ItemBase("red_nugget", CreativeTabsRegister.MATERIALS);
    public static Item red_ingot = new ItemBase("red_ingot", CreativeTabsRegister.MATERIALS);

    //fireItems]


    public static Item fire_pickaxe =  new FirePickaxeItem("fire_pickaxe",RED_MATERIAL);
    public static Item fire_axe = new FireAxeItem("fire_axe",RED_MATERIAL,15,8f);
    public static Item fire_sword = new FireSwordItem("fire_sword",RED_MATERIAL);
    public static Item fire_hoe = new FireHoeItem("fire_hoe",RED_MATERIAL);
    public static Item fire_shovel = new FireShovelItem("fire_shovel",RED_MATERIAL);

/*    public static Item Red_Pickaxe = new PickaxeBase("red_pickaxe", RED_MATERIAL);
    public static Item Red_Coin = new ItemBase("red_coin", CreativeTabsRegister.MATERIALS);
    public static Item Red_Axe = new AxeBase("red_axe", RED_MATERIAL, 15.0f, 8.0f);
    public static Item red_Sword = new SwordBase("red_sword", RED_MATERIAL);
    public static Item red_spade = new ShovelBase("red_spade", RED_MATERIAL);
    public static Item red_hoe = new HoeBase("red_hoe", RED_MATERIAL);*/
    ///
    public static Item Stone_stick = new ItemBase("stone_stick", CreativeTabsRegister.MATERIALS);
    //Matterials
    public static Item EmeraldNugget = new ItemBase("emerald_nugget", CreativeTabsRegister.MATERIALS);
    public static Item PressedStickWooden = new ItemBase("pressed_wooden_stick", CreativeTabsRegister.MATERIALS);
    public static Item NaturalIngot = new ItemBase("natural_ingot", CreativeTabsRegister.MATERIALS);
    public static Item natural_amulet = new NaturalAmuletItem("natural_amuelt", CreativeTabsRegister.TOOL);
    //armor fixme
    public static Item BOOTS = new com.MLag.RedCraft.Armor.ItemArmor("fire_boots", RED_ARMOR_MATERIAL, 1, EntityEquipmentSlot.FEET);
    public static Item LEGGS = new com.MLag.RedCraft.Armor.ItemArmor("fire_leggs", RED_ARMOR_MATERIAL, 2, EntityEquipmentSlot.LEGS);
    public static Item Chestplate = new com.MLag.RedCraft.Armor.ItemArmor("fire_chestplate", RED_ARMOR_MATERIAL, 1, EntityEquipmentSlot.CHEST);
    public static Item HEAD = new com.MLag.RedCraft.Armor.ItemArmor("fire_helmet", RED_ARMOR_MATERIAL, 1, EntityEquipmentSlot.HEAD);
    ...
    public static Item fire_multitool = new FireMultiToolItem("fire_multitool", FIRE_MATERIAL);
    ...
    public static Item ice_hoe = new IceHoeBase("ice_hoe", ICE_MATERIAL);
    ...
    public static Item natural_hoe = new NaturalHoeBase("natural_hoe", NATURAL_MATERIAL);
